...
def getNetwoks(_orgId, _apikey):
    url = "https://api.meraki.com/api/v0/organizations/"+str(_orgId)+"/networks"
...
if __name__ == "__main__":
    ...
    for ele in orga:
        if ele["id"] == 127342:
            ...
            print("respuesta del API Networks (Json)",json.dumps(networks, indent=2))

            for network in networks:
                if network["id"] == "L_591660401045801690":
                    devices=
